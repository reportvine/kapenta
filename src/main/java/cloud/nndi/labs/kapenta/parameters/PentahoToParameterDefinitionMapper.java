package cloud.nndi.labs.kapenta.parameters;
...
public class PentahoToParameterDefinitionMapper {
    ...
    public ParameterDefinition map(ParameterDefinitionEntry param, MasterReport pentahoReport) {
        ...
        if (param.isMandatory()) {
            return ParameterDefinition.requiredParameter(param.getName(),
                    defaultValue,
                    param.getValueType());
        }
        return ParameterDefinition.optionalParameter(param.getName(),
                defaultValue,
                param.getValueType());
    }
}
